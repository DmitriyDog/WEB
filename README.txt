...
При регистрации пользователь переходит в свой пустой профиль. Там вверху изображен никнейм, ниже дата регистрации с точностью до дня и еще ниже виден пустой список. Еще ниже можно изменить свой никнейм и поле "обо мне" с помощью кнопки "Редактировать профиль", а также выйти из профиля.
...
При регистрации нужно указать почту, которой еще нет в базе данных сайта, любой никнейм и любой пароль.
